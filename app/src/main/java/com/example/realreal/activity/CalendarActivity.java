...
import com.example.realreal.ViewActivity;
...
public class CalendarActivity extends AppCompatActivity {
    ...
    public void removeDiary(String readDay){
        ...
        try{
            fos=openFileOutput(readDay,MODE_NO_LOCALIZED_COLLATORS);  //사용자가 입력한 내용을 삭제 및 수정 하는 부분
            String content="";
    ...
    public void saveDiary(String readDay){
        ...
        try{
            fos=openFileOutput(readDay,MODE_NO_LOCALIZED_COLLATORS);  // 사용자가 입력한 내용을 저장 하는 부분
